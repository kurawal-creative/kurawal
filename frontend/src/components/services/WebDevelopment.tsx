			...
			<section className="relative mx-auto max-w-350 border-dashed px-6 py-12 min-[1400px]:border-x min-[1800px]:max-w-384">
				<div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
					<div className="space-y-4">
						<h2 className="text-2xl leading-tight font-bold text-neutral-800 sm:text-3xl md:text-4xl dark:text-neutral-100">Web Development</h2>
						<p className="max-w-xl text-sm leading-relaxed text-neutral-700 sm:text-base dark:text-neutral-400">Our web development services help you create responsive, user-friendly websites that drive engagement and conversions.</p>
					...
					<div className="border border-dashed border-neutral-300 bg-neutral-50/60 p-4 dark:border-neutral-700 dark:bg-neutral-900/40">
						<div className="flex min-h-64 items-center justify-center rounded-xl border border-dashed border-neutral-300 bg-white text-sm font-medium text-neutral-500 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-300">Web Project Preview</div>
					</div>
				</div>
			</section>
		</>
